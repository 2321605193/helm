...
export function loadProfile(name: string, harnessDir: string): ProfileConfig | null {
...
export function listProfiles(harnessDir: string): string[] {
...
function findGateScript(gateName: string, gatesDir: string): string | null {
  const candidates = [
